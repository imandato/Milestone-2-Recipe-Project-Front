...
function SearchForm(props){
    return(
        <div className='form'>
            <div>
            <img style={{ height: "570px", width: "55%", position: "relative", left: "80px", backgroundSize: "contain", backgroundRepeat: "no-repeat", borderRadius: "10px", marginBottom: "70px", border: "1px solid #E8E9EB" }} src="https://t4.ftcdn.net/jpg/03/78/97/59/360_F_378975954_G39M4ptXAjxKy80gbBIEo0wqBkk89gBF.jpg" alt="Card image" />
            </div>
            <div style={{ display: "grid", position: "absolute", top: "185px", left: "100px" }}>
